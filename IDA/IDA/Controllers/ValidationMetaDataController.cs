...
{
    [Authorize]
    public class ValidationMetaDataController : BaseController
    {
        public ValidationMetaDataController()
        {
        ...
        {
            ViewBag.Name = "Column Definitions";
        ...
        public ActionResult FormTypeMapping()
        {
            ViewBag.Name = "Form Type Mapping";
        ...
        public ActionResult ColumnDefMapping()
        {
            ViewBag.Name = "Column Def. Mapping";
        ...
        public ActionResult ColumnDefRules()
        {
            ViewBag.Name = "Column Def. Rules";
        ...
        public ActionResult ValidationEnumerations()
        {
            ViewBag.Name = "Validation Enumerations";
        ...
        public ActionResult RuleErrorMessages()
        {
            ViewBag.Name = "Rule Error Messages";
        ...
        public ActionResult ValidationRules()
        {
            ViewBag.Name = "Validation Rules";
